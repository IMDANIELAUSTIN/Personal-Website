const projects = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'text', content: "Sole Folks identity system was mostly developed before our studio became involved. Our work was to further refine the brand while I was in charge of creating a brand pattern, developement of Brand Guidelines, and layout designs for presentations. The mark draws on symbolic elements that resonate across cultures and I took that fooundation to juxtapose it with the concept of designs found on the soles of a shoe and broken chains. The result is a system that is adaptable while serving the organization's diverse communication needs across events, publications, and digital platforms. The pattern can currently be seen on the Front Facade of Sole Folks at Leimert Park." },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'video', url: 'assets/akkurat mograph.webm' },
